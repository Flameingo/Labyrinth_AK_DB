...
public class AbschnittB extends Objekt
{
  ...
  protected Objekt [] steine = new Objekt[21];
  ...
  public AbschnittB()
  {
	  ...
	  waende[44] = new RundeTreppe(13.5f,-6,-2.1f,180,0,0,360,11);
	  waende[45] = new LabWeg_L(new Level (9,4));
	  
	  waende[46] = new LabEck_lo(new Level(10,5),Etage.KELLER , true);
	  waende[47] = new LabEck_ro(new Level(9,5),Etage.KELLER, true);
	  waende[48] = new LabEck_lu(new Level(10,4),Etage.KELLER,true);
