...
public class Zinne extends WandBlock
{
  ...
  public Zinne(float x, float y, float z, float w1, float w2, float w3)
  {
    ...
    for (int oben = 0; oben < 10; oben++)
    {
      ...
      {
        myShape.addParam(new Quader("Mitte", 0.125f, wdbreite, 0.05f), new Point(-0.065f + qX, 0, oben * 0.06f+boden)); //Erschafft die kurzen Stein am rechten und linken Rand des St¸cks
