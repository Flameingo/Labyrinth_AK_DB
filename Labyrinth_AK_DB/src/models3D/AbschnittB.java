...
public class AbschnittB extends Objekt
{
  ...
  public AbschnittB()
  {
	  ...
	  waende[1] = new LabWeg_L(new Level(2,2));
	  waende[2] = new LabWeg_o_u(new Level (2,3));
	  waende[3] = new LabWeg_o_u(new Level(2,4));
	  waende[4] = new LabWeg_O(new Level(1,2));
	  waende[5] = new Eckstein(new Level(2,2));
  }
  public void feld(Objekt obj, int a, int b)
  {
