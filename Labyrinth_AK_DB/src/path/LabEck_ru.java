...
public class LabEck_ru extends Lab
{
  ...
  {
    if (bogen == true) waende[2] = new Wand("E", x + 1.75f, y2 - 1.75f, boden, 90, 0, 0, 90, hoehe);
    
    if (bogen == false) waende[2] = new Wand("E", x, y2, boden, 270, 0, 0, 90, hoehe);
  ...
  public LabEck_ru(Etage e, float x, float y, float x2, float y2, boolean bogen, float hoehe)
  {
    ...
    if (bogen == true) waende[2] = new Wand("E", x + 1.75f, y2 - 1.75f, boden + 2.1f * e.wert(), 90, 0, 0, 90, hoehe);
    
    if (bogen == false) waende[2] = new Wand("E", x, y2, boden + 2.1f * e.wert(), 270, 0, 0, 90, hoehe);
