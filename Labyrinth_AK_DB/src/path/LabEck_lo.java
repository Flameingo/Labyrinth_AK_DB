 ...
 */
  public LabEck_lo(float x, float y, float x2, float y2, float hoehe, boolean bogen)
  {
	...
	if(bogen == true)		
		waende [2] = new Wand ("E",x2-1.75f,y+1.75f,boden,270,0,0,90,hoehe);
	if(bogen == false)
		waende[2] = new Wand ("E",x2,y,boden,90,0,0,90,hoehe);
  ...
  public LabEck_lo(Level lev, Etage e,boolean bogen)
  {
	  this(e,lev.x1,lev.y1,lev.x2,lev.y2,bogen);
  }
  
  public LabEck_lo(Etage e, float x, float y, float x2, float y2, boolean bogen)
  {
   
	waende = new Objekt[3];
	  
	if(bogen == true)		
		waende [2] = new Wand ("E",x2-1.75f,y+1.75f,boden+e.wert()*2.1f,270,0,0,90,2);
	if(bogen == false)
		waende[2] = new Wand ("E",x2,y,boden+e.wert()*2.1f,90,0,0,90,2);
