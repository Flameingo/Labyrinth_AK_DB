...
public enum Material
{
  ...
  BACKSTEIN2(0.2f, 0, .005f, 1, .3f, 0, 0, 1, .1f, 0, 0, .6f, 1),
  BACKSTEIN3(.3f, .005f, 0, 1, .2f, .005f, 0, 1, 0, 0, .1f, .7f, 1),
  FOG(.1f, .15f, .2f, .2f, 0, 0, 0, .2f, 0, 0, 0, .2f, 0, .1f, .15f, .3f, .2f),
  FOGFINAL(.1f, .15f, .2f, 1f, 0, 0, 0, 1f, 0, 0, 0, 1f, 0),
  ...
  SCHRIFT_WEISS(.9f, .9f, .9f, 1, .1f, .1f, .1f, 1, 0, 0, 0, 1, 1);
